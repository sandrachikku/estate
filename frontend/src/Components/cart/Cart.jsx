              ...
              <div key={index} className="bg-white p-4 shadow-md rounded-lg flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <Link to={`/product/${item.product._id}`}>
                    <img src={item.product.pimages[0]} alt={item.product.pname} className="w-20 h-20 object-cover rounded" />
                  </Link>
                  <div>
                    <h4 className="text-lg font-semibold">{item.product.pname}</h4>
